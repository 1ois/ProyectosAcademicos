...
@Composable
fun PlinView(navController: NavHostController) {
    Scaffold(
        topBar = { plinSuperior(navController)},
        content = { paddingInterno ->
            Surface(modifier = Modifier.padding(paddingInterno)){
                plinContenido(navController)
            }
        },
...
@Composable
fun plinSuperior(navController: NavHostController) {
...
@Composable
fun plinContenido(navController: NavHostController) {
    val backgroundColor = Color(106, 57, 0)
    Box(
